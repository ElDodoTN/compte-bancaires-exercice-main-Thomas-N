...
class TestCompteCourant():
    ...
    def test_cc_a_un_solde_a_zero_par_defaut(self, compte_courant:CompteCourant) -> None:
    ...
    def test_cc_plusieurs_versements(self,compte_courant:CompteCourant) -> None:
        """
    ...
    def test_cc_versement_negatif_genere_exception(self, compte_courant :CompteCourant, montant :int) -> None:
    ...
    def test_cc_retrait_trop_eleve_genere_exception(self,compte_courant :CompteCourant) -> None:
